...
namespace Tests\Setono\SyliusFacebookTrackingPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Setono\SyliusFacebookTrackingPlugin\Behat\Page\Shop\WelcomePageInterface;

...
final class PixelType extends AbstractResourceType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('accessToken', TextareaType::class, [
                'label' => 'setono_sylius_facebook.form.pixel.access_token',
                'required' => false,
                'attr' => [
                    'rows' => 3,
                    'placeholder' => 'setono_sylius_facebook.form.pixel.access_token_placeholder',
                ],
            ])
